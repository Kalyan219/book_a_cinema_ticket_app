...
const CinemaSeatBooking = ({
    ...
    subtitle = "Select your preffered seats",
}) => {
  ...
  return (
    <div className='min-h-screen w-full bg-gray-50 p-4 '>
        ...
        <div className='max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-6'>
          ...
          {/* screen */}
          <div className='mb-8'>
            <div className='w-full h-4 bg-gradient-to-r from-gray-300 via-gray-400 to-gray-300
                 mb-2 shadow-inner rounded-lg' />
        ...
        <div className='flex flex-wrap justify-center gap-6 mb-6 p-4 bg-gray-50 rounded-lg'>
          {uniqueSeatTypes.map((seatType) => {
            return <div className='flex items-center' key={seatType.type}>
